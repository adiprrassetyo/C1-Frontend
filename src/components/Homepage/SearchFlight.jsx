                ...
                <form onSubmit={handleSubmit}>
                    <Row className='opsi-flight'>
                        <Col md={2} sm={6} xs={6}>
                            ...
                            ></input>
                            <label htmlFor='sekalijalanInput'>
                                Sekali Jalan
                            </label>
                        </Col>
                        <Col md={2} sm={6} xs={6} className='opsi-flight-right'>
                            <input
                                ...
                                onChange={handleChange}
                            ></input>
                            <label htmlFor='pulangpergiInput'>
                                Pulang Pergi
                            </label>
                        </Col>
                    </Row>
                    ...
                    <Row className='form-outline'>
                        <Col md={2} className='mb-0'>
                            <Form.Group className='mb-3'>
                                <Form.Label htmlFor='kotaberangkat'>
                                    Dari
                                </Form.Label>
                                {/* <Form.Control
                  type="text"
                  ...
                  Tanggal Pergi
                        ...
                        <Col md={2} className='form'>
                            <Form.Group className='mb-3'>
                                ...
                                <DropdownButton
                                    title={
                                        countDewasa + countAnak + ` Traveler`
                                    }
                                    ...
                                    <div className='dropdown-item-traveler dewasa'>
                                        <Row className='align-items-center'>
                                            <Col md={6} sm={6} className='p-0'>
                                                <p className='traveler-title'>
                                                    Dewasa
                                                </p>
                                                <p className='traveler-desc'>
                                                    Umur 12+
                                                </p>
                                            </Col>
