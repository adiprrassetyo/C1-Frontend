...
import { Container, Row, Col, Form, Badge, Accordion, Button, Spinner} from "react-bootstrap";
                ...
                <Form onSubmit={handleSubmit}>
                    <Row>
                            ...
                            <div className="contact-info-session">
                                ...
                                <div className="info-content">
                                    ...
                                    <Col md={8} className="left-col-section">
                                        ...
                                        >
                                        <option value="">{user.gender=="perempuan" ? `Ny. ${user.firstname} ${user.lastname}`: `Tn. ${user.firstname} ${user.lastname}`}</option>
                                        </select>
                                    </Form.Group>
                                    </Col>
                                    <Col md={8} className="left-col-section">
                                        ...
                                        name="title"
                                        className="dropdown-toggle"
                                        value={user.gender=="perempuan" ? `nyonya`: `tuan`}
                                        >
                                        ...
                                        return(
                                            <Container>
                                                <Row className="traveler-type">
                                                    <Col md={2} sm={3} xs={4}> <h3 className="card-title"><i className="ri-user-line icon"></i><span>Traveler {item.index}</span></h3></Col>
                                                ...
                                                <Row className="traveler-info">
                                                    ...
                                                    <Col md={8}>
                                                        <Form.Group className=" mb-4 mt-2 border border-top-0 border-start-0 border-end-0">
                                                            ...
                                                            className="dropdown-toggle "
                                                            >
                                                            <option value="tuan">{user.gender=="perempuan" ? `Ny. ${user.firstname} ${user.lastname}`: `Tn. ${user.firstname} ${user.lastname}`}</option>
                                                            </select>
                                                        </Form.Group>
                                                    </Col>
                                                    <Col md={8}>
                                                        <Form.Group className=" mb-4 border border-top-0 border-start-0 border-end-0">
                                                            ...
                                                            value={adultForm[item.index-1].title}
                                                            >
                                                            <option value="tuan">Tuan</option>
                                                            <option value="nyonya">Nyonya</option>
                                                            <option value="nona">Nona</option>
                                                ...
                                                <Row className="traveler-row">
                                                    <Col md={4}>
                                                        ...
                                                        placeholder="ex: Rangga Laksana"
                                                        onChange={handleChangeAdult}
                                                        value={adultForm[item.index-1].name}
                                                        />
                                                        </Form.Group>
                                                    </Col>
                                                    <Col md={4}>
                                                        ...
                                                        onChange={handleChangeAdult}
                                                        value={adultForm[item.index-1].surname}
                                                        />
                                                        </Form.Group>
                                                    </Col>
                                                </Row>
                                                <Row className="traveler-row">
                                                    <Col md={8}>
                                                        ...
                                                        value={adultForm[item.index-1].datebirth} 
                                                        clearIcon={null}
                                                        />
                                                        </Form.Group>
                                                    </Col>
                                                ...
                                                <Row className="traveler-row">
                                                    <Col md={8}>
                                                        <Form.Group className="mb-2 border border-top-0 border-start-0 border-end-0">
                                                            ...
                                                            value={adultForm[item.index-1].id_card}
                                                            >
                                                    ...
                                                    {adultForm[item.index-1].id_card ==='ktp' && (
                                                            <Col md={8}>
                                                                ...
                                                                onChange={handleChangeAdult}
                                                                value={adultForm[item.index-1].no_ktp}
                                                                />
                                                                </Form.Group>
                                                            </Col>
                                                    )}

                                                {adultForm[item.index-1].id_card ==='paspor' && (
                                        ...
                                        return(
                                            <Container>
                                                <Row className="traveler-type">
                                                    <Col md={2} sm={3} xs={4}> <h3 className="card-title"><i className="ri-user-line icon"></i><span>Traveler {item.index}</span></h3></Col>
                                                    <Col md={1} sm={1} xs={1} className="text-center"> <p> | </p> </Col>
                                                    <Col md={2} sm={3} xs={7}> <p>Anak-anak</p> </Col>
                                                    <Col md={7} sm={5} xs={12} className="d-flex flex-row-reverse checklist-box">
                                                    </Col>
                                                </Row>
                                                <Row className="traveler-info">
                                                ...
                                                <Row className="traveler-row">
                                                    <Col md={4}>
                                                        ...
                                                        value={childForm[item.index-1].name}
                                                        />
                                                        </Form.Group>
                                                    </Col>
                                                    <Col md={4}>
                                                        ...
                                                        placeholder="ex: Miller"
                                                        onChange={handleChangeChild}
                                                        value={childForm[item.index-1].surname}
                                                        />
                                                        </Form.Group>
                                                    </Col>
                                                </Row>
                                                <Row className="traveler-row">
                                                    <Col md={8}>
                                                        ...
                                                        value={childForm[item.index-1].datebirth}
                                                        clearIcon={null}
                                                        />
                                                        </Form.Group>
                                                    </Col>
                            ...
                            <div className="adding-section">
                                ...
                                <Row className="rute-detail">
                                    <Col md={10} sm={10} xs={10} >
                                        <p>{ticketById.from} - {ticketById.to} </p>
                                    </Col>
                        ...
                        <Col md={4} className="right-section">
                            ...
                            <Button className="continue-btn" type="submit" onClick={handleSubmit}>{ loading? <Spinner animation="border" variant="info" /> : "Lanjutkan"}</Button>
