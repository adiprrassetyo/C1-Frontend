...
import { Container, Row, Col, Button, Dropdown, DropdownButton, Card, Accordion, Form } from "react-bootstrap";
    ...
    return (
        <div>
            ...
            <Container fluid className="search">
                <Card className="search-content mb-5">
                    ...
                    <Card.Body className="search-body">
                        <Row className="filter flex-filter">
                            ...
                            <Col className="m-1" md={1}>
                                <DropdownButton id="dropdown-basic-button" title="Harga" autoClose="outside">
                                    <Dropdown.ItemText>
                                        <h3>Harga</h3>   
                                    </Dropdown.ItemText>
                                    <Dropdown.ItemText>
                            ...
                            <Col className="m-1 me-4" md={1}>
                                <DropdownButton id="dropdown-basic-button" title="Pemberhentian" autoClose="outside">
                                    <Dropdown.ItemText>
                                        <h3>Pemberhentian</h3>
                                    </Dropdown.ItemText>
                                    <Dropdown.ItemText>
                            ...
                            <Col className="m-1 ms-2" md={1}>
                                <DropdownButton id="dropdown-basic-button" title="Maskapai" autoClose="outside">
                                    <Dropdown.ItemText>      
                                        <h3>Maskapai</h3>
                                    </Dropdown.ItemText>
                                    <Dropdown.ItemText>
                            ...
                            <Col className="m-1 ms-2" md={1}>
                                <DropdownButton id="dropdown-basic-button" title="Keberangkatan" autoClose="outside">
                                    <Dropdown.ItemText>
                                        <h3>Keberangkatan</h3>
                                        
                                    </Dropdown.ItemText>
                                    <Dropdown.ItemText>
                                        <Form.Check aria-label="option 1" label="Penerbangan Pagi"/>
                                        <Form.Check aria-label="option 2" label="Penerbangan Siang"/>
                                        <Form.Check aria-label="option 3" label="Penerbangan Malam"/>
                                    </Dropdown.ItemText>
                                </DropdownButton>
                            </Col>
                            ...
                            <Accordion.Header>
                                <Row className="flight-header">
                                    ...
                                    <Col className="flight-box-price pt-3">
                                        <h3><strong>US$47.49</strong><span> /Org</span></h3>
                                    </Col>
                                    <Col className="pt-2">
                                        <Button
                                            variant="light"
                                            ...
                                            <Col xs={11} className="timeline-info pt-3">
                                                <div className="timeline-departure timeline-flex">
                                                    <div className="timeline-datetime me-5">
                                                        <h2 className="timeline-departure-time"><strong>06:00</strong></h2>
                                                        <p className="timeline-departure-date">11 Dec 2022</p>
                                                    </div>
                                                    <div className="timeline-cityairport">
                                                        <p className="timeline-departure-city mb-0">Jakarta (CGK)</p>
                                                        <p className="timeline-departure-airport mb-0">Soekarno Hatta International Airport</p>
                                                        <p className="timeline-departure-terminal">Terminal 2E</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="timeline-arrival timeline-flex">
                                                    <div className="timeline-datetime me-5">
                                                        <h2 className="timeline-arrival-time"><strong>07:50</strong></h2>
                                                        <p className="timeline-arrival-date">11 Dec 2022</p>
                                                    </div>
                                                    <div className="timeline-cityairport">
                                                        <p className="timeline-arrival-city mb-0">Bali Denpasar (DPS)</p>
                                                        <p className="timeline-arrival-airport mb-0">Ngurah Rai International Airport</p>
                                                        <p className="timeline-arrival-terminal">Terminal 2E</p>
                                                    </div>
                                                </div>
                                            </Col>
                                        </Row>
                                    ...
                                    <Col xs={7}>
                                        <Row>
                                            ...
                                            <Col xs={11} className="timeline-info pt-3">
                                                <div className="timeline-departure timeline-flex">
                                                    <div className="timeline-datetime me-5">
                                                        <h2 className="timeline-departure-time"><strong>17:00</strong></h2>
                                                        <p className="timeline-departure-date">12 Dec 2022</p>
                                                    </div>
                                                    <div className="timeline-cityairport">
                                                        <p className="timeline-departure-city mb-0">Jakarta (CGK)</p>
                                                        <p className="timeline-departure-airport mb-0">Soekarno Hatta International Airport</p>
                                                ...
                                                <div className="timeline-arrival timeline-flex">
                                                    <div className="timeline-datetime me-5">
                                                        <h2 className="timeline-arrival-time"><strong>18:50</strong></h2>
                                        ...
                                        <Row>
                                            ...
                                            <Col xs={11} className="timeline-info pt-3">
                                                <div className="timeline-departure timeline-flex">
                                                    <div className="timeline-datetime me-5">
                                                        <h2 className="timeline-departure-time"><strong>06:00</strong></h2>
                                                        <p className="timeline-departure-date">10 Dec 2022</p>
                                                    </div>
                                                    <div className="timeline-cityairport">
                                                        <p className="timeline-departure-city mb-0">Jakarta (CGK)</p>
                                                        <p className="timeline-departure-airport mb-0">Soekarno Hatta International Airport</p>
                        ...
                        <Accordion.Item eventKey="3">
                            <Accordion.Header>
                                <Row className="flight-header">
                                    ...
                                    <Col className="flight-box-price pt-3">
                                        <h3><strong>US$52.37</strong><span> /Org</span></h3>
                                    </Col>
                                    <Col className="pt-2">
                                        <Button
                                            variant="light"
                                    ...
                                    <Col xs={7}>
                                        <Row>
                                            ...
                                            <Col xs={11} className="timeline-info pt-3">
                                                <div className="timeline-departure timeline-flex">
                                                    <div className="timeline-datetime me-5">
                                                        <h2 className="timeline-departure-time"><strong>14:00</strong></h2>
                                                        <p className="timeline-departure-date">10 Dec 2022</p>
                                                    </div>
                                                    <div className="timeline-cityairport">
                                                        <p className="timeline-departure-city mb-0">Jakarta (CGK)</p>
                                                ...
                                                <div className="timeline-arrival timeline-flex">
                                                    <div className="timeline-datetime me-5">
                                                        <h2 className="timeline-arrival-time"><strong>15:50</strong></h2>
                                                        <p className="timeline-arrival-date">10 Dec 2022</p>
                                                    </div>
                                                    <div className="timeline-cityairport">
                                                        <p className="timeline-arrival-city mb-0">Bali Denpasar (DPS)</p>
                                ...
                                <Row className="flight-header">
                                    ...
                                    <Col className="me-5">
                                        <div className="flight-box-time time-flight-flex">
                                            ...
                                            <div>
                                                <h3><strong>00:05</strong><span className="plus-one-day p-1">+1d</span></h3>
                                                <p>DPS</p>
                                            </div>
                                        </div>
                                    </Col>
                                    ...
                                    <Col xs={7}>
                                        <Row>
                                            ...
                                            <Col xs={11} className="timeline-info pt-3">
                                                <div className="timeline-departure timeline-flex">
                                                    <div className="timeline-datetime me-5">
                                                        <h2 className="timeline-departure-time"><strong>22:15</strong></h2>
                                                        <p className="timeline-departure-date">11 Dec 2022</p>
                                                    </div>
                                                    <div className="timeline-cityairport">
                                                        <p className="timeline-departure-city mb-0">Jakarta (CGK)</p>
                                                ...
                                                <div className="timeline-arrival timeline-flex">
                                                    <div className="timeline-datetime me-5">
                                                        <h2 className="timeline-arrival-time"><strong>00:05</strong><span className="plus-one-day-detail p-1">+1d</span></h2>
                                                        <p className="timeline-arrival-date">12 Dec 2022</p>
                                                    </div>
                                                    <div className="timeline-cityairport">
                                                        <p className="timeline-arrival-city mb-0">Bali Denpasar (DPS)</p>
                        ...
                        <Accordion.Item eventKey="5">
                            <Accordion.Header>
                                <Row className="flight-header">
                                    ...
                                    <Col className="flight-box-price pt-3">
                                        <h3><strong>US$55.93</strong><span> /Org</span></h3>
                                    </Col>
                                    <Col className="pt-2">
                                        <Button
                                            variant="light"
                                    ...
                                    <Col xs={7}>
                                        <Row>
                                            ...
                                            <Col xs={11} className="timeline-info pt-3">
                                                <div className="timeline-departure timeline-flex">
                                                    <div className="timeline-datetime me-5">
                                                        <h2 className="timeline-departure-time"><strong>11:00</strong></h2>
                                                        <p className="timeline-departure-date">11 Dec 2022</p>
                                                    </div>
                                                    <div className="timeline-cityairport">
                                                        <p className="timeline-departure-city mb-0">Jakarta (CGK) </p>
                                                ...
                                                <div className="timeline-arrival timeline-flex">
                                                    <div className="timeline-datetime me-5">
                                                        <h2 className="timeline-arrival-time"><strong>13:50</strong></h2>
                                                        <p className="timeline-arrival-date">11 Dec 2022</p>
                                                    </div>
                                                    <div className="timeline-cityairport">
                                                        <p className="timeline-arrival-city mb-0">Bali Denpasar (DPS)</p>
