                        ...
                        <Row>
                            <Col md={4} className='feature-col'>
                                ...
                                <p className='feature-desc'>
                                    Rasakan fleksibilitas dan kemudahan selama
                                    proses pemesanan
                                </p>
                            </Col>
                            <Col md={4} className='feature-col'>
                                ...
                                <p className='feature-desc'>
                                    Pengalaman memesan bebas stress dengan
                                    pembayaran, mata uang, dan bahasa lokal
                                </p>
                            </Col>
                            <Col md={4} className='feature-col'>
                                <img
                                ...
                                <p className='feature-desc'>
                                    Nikmati momen yang mengesankan dengan jutaan
                                    penerbangan dan akomodasi yang menguntungkan
                                </p>
                            </Col>
                            <Col md={4} className='feature-col'>
                                <img
                                ...
                                <p className='feature-desc'>
                                    Berbagai macam promo harian dengan harga
                                    yang terjangkau untuk semua traveler
                                </p>
                            </Col>
                            <Col md={4} className='feature-col'>
                                <img
                                ...
                                <p className='feature-desc'>
                                    Bersama dengan mitra terpercaya kami,
                                    memenuhi kebutuhan traveler yang jumlah nya
                                    tak terhitung sejak 2011
                                </p>
                            </Col>
                            <Col md={4}>
                                <img
                                ...
                                <p className='feature-desc'>
                                    Layanan pelanggan kami tersedia 24/7
                                    memberikan bantuan terbaik dalam bahasa
                                    lokal Anda
                                </p>
                            </Col>
                        </Row>
                    ...
                    <Row className='align-items-center'>
                        <Col md={5} className='promo-section-left'>
                            ...
                            <p className='section-desc'>
                                Ingin perjalanan menyenangkan dengan budget yang
                                ramah dikantong? Yuk temukan promo menarik yang
                                menanti perjalanmu dengan BinAir
                            </p>
                            <Button
                                href='/#/promo'
                    ...
                    <Container>
                        <Row className='align-items-center'>
                            ...
                            <Col
                                ...
                                sm={6}
                                xs={12}
                                className='text-mobile-section'
                            >
                                <p>
                                    Unduh Aplikasi BinAir Sekarang,Pesan tiket
                                    pesawat dengan lebih mudah!
                                </p>
                                <a href='#'>
                                    <img
                                        src={google_play}
