...
const AddPromos = () => {
  ...
  function handleSubmit(event) {
    ...
    dispatch(createPromo({ formData: { ...formData, promo_image }, redirect }));
            ...
            <Form className="" onSubmit={handleSubmit} style={{ width: "40%" }}>
              <Row>
                <Form.Group className="mb-3">
                  <Form.Label className="m-0 p-0">Title</Form.Label>
                  <Form.Control
                    required
                    type="text"
                ...
                <Form.Group className="mb-3">
                  <Form.Label className="m-0 p-0">Description</Form.Label>
                  <Form.Control
                    required
                    as="textarea"
                    value={formData.desc}
                ...
                <Form.Group className="mb-3">
                  <Form.Label className="m-0 p-0">Code Promo</Form.Label>
                  <Form.Control
                    required
                    type="text"
                ...
                <Row>
                  <Col>
                    <Form.Group className="mb-3">
                      <Form.Label className="m-0 p-0">Discount</Form.Label>
                      <Form.Control
                        required
                        type="number"
                ...
                <Form.Group className="mb-3">
                  <Form.Label className="m-0 p-0">Terms</Form.Label>
                  <Form.Control
                    required
                    type="text"
                ...
                <Form.Group className="mb-3">
                  <Form.Label className="m-0 p-0">Promo Image</Form.Label>
                  <Form.Control
                    required
                    type="file"
                    size="md"
