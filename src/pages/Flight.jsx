...
const Flight = () => {
    ...
    const [from, setFrom] = useState([
        { code: null, city: null, airport: null },
    ])
    ...
    return (
        <Container fluid className='flight'>
            ...
            <Container
                fluid
                className='jumbotronFlight d-flex align-items-center'
            >
                <Container fluid='xl'>
                    <Row className='align-items-center jumbotron-content'>
                        <Col className='flight-form '>
                            <Form
                                className='flight-form col'
                      ...
                      >
                        ...
                        <Col>
                            <h2 className='text-white'>
                                Temukan, Bandingkan, dan Pesan Penerbanganmu
                                dengan mudah
                            </h2>
                        </Col>
                    </Row>
