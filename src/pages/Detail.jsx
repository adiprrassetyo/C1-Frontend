                ...
                <div className="panel">
                    <div className="panel-block d-flex justify-content-between">
                        <div className="p-4 pb-0 pt-2">
                            <p className="is-grey mb-0">Penerbangan Keberangkatan</p>
                            <h3 className="normal">Jakarta (CGK) <i class="remix-icon ri-arrow-right-line is-grey ms-2"></i> Bali Denpasar (DPS) </h3>
                            ...
                            <div className="modal-flight-timeline d-flex">
                                <div className="time-line d-flex flex-column justify-content-center align-items-center">
                                    <div className="icon circle icon-fw d-inline-flex justify-content-center align-items-center">
                                        <svg class="svg-inline--fa fa-circle fa-w-16 fa-fw" data-prefix="far" data-icon="circle" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                                    ...
                                    <div className="icon circle icon-fw d-inline-flex justify-content-center align-items-center">
                                        <svg class="svg-inline--fa fa-circle fa-w-16 fa-fw" data-prefix="fas" data-icon="circle" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                                ...
                                <div className="modal-timeline-info">
                                    <div className="modal-timeline-departure d-flex">
                                        <div className="timeline-datetime mt-3">
                                            <h3 className="normal mb-0">12:00</h3>
                                            <p className="is-grey mb-0 normal me-3">2 Januari 2023</p>
                                        </div>
                                        <div className="modal-timeline-cityairport mt-3">
                                            <h3 className="normal mb-0">Jakarta (CGK)</h3>
                                            <p className="is-grey mb-0 normal">Bandara Internasional Soekarno Hatta</p>
                                            <p className="is-grey mb-0 normal">Terminal 2E</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="modal-timeline-arrival d-flex">
                                        <div className="timeline-datetime mt-3">
                                            <h3 className="normal mb-0">14:50</h3>
                                            <p className="is-grey normal mb-0 me-3">2 Januari 2023</p>
                                        </div>
                                        <div className="modal-timeline-cityairport mt-3">
                                            <h3 className="normal mb-0">Bali Denpasar (DPS)</h3>
                                            <p className="is-grey normal mb-0">Bandara Internasional Ngurah Rai</p>
                                            <p className="is-grey normal mb-0">Terminal Domestic</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="modal-flight-facility p-4">
                            <div className="flight-facility pt-3">
                                <div className="facility-item d-flex mb-2">
                                    <img src={Refund} alt="" />
                                    <p className="normal ms-2 mb-0">Bisa Refund</p>
                                </div>
                                <div className="facility-item d-flex mb-2">
                                    <img src={Reschedule} alt="" />
                                    <p className="normal ms-2 mb-0">Perubahan Jadwal</p>
                                </div>
                                <div className="facility-item d-flex mb-2">
                                    <img src={Cabin} alt="" />
                                    <p className="normal ms-2 mb-0">Bagasi Kabin 7kg</p>
                                </div>
                                <div className="facility-item d-flex mb-2">
                                    <img src={Baggage} alt="" />
                                    <p className="normal ms-3 mb-0">Bagasi 20kg</p>
                                </div>
                                <div className="facility-item d-flex mb-2">
                                    <img src={Entertainment} alt="" />
                                    <p className="normal ms-2 mb-0">Hiburan</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="modal-payment-history-container">
                    <div className="modal-payment-detail d-flex justify-content-between align-items-center p-2">
                        ...
                        <div className="modal-payment-status-info d-flex flex-column align-items-end">
                            ...
                            <h3 className="normal mt-4">Jumat, 30 Desember 2022</h3>
                        </div>
                    ...
                    <Container fluid="xl" className="account-main p-3">
                        <Row>
                            <Col xs={3} className="left-panel left-flex">
                                ...
                                <Button href="/#/account/order" className="mb-3" variant="info" size="lg">
                            ...
                            <Col xs={9} className="content-panel ps-5">
                                <Button className="back-button ms-3 mb-2" href="#/account/order" variant="outline-info">
                                        Kembali
                                </Button>
                                <Container className="order-detail">
                                    <Card className="first-detail p-2">
                                        <Card.Header className="d-flex justify-content-between align-items-center">
                                            <div className="first-detail-left">
                                                ...
                                                <p className="is-grey">KODE BINAIR : <strong>1017993455</strong></p>
                                                <p className="is-grey"><strong>Tanggal pemesanan 30 Desember 2022</strong></p>
                                            </div>
                                        ...
                                        <Card.Body>
                                            <p className="is-grey">Kadaluarsa pada Jum, 30 Des 2022 18:47 (GMT + 7)</p>
                                            <Button href="#/flight/booking" variant="outline-info">
                                    ...
                                    <Card className="second-detail p-3">
                                        ...
                                        <Row className="mt-4">
                                            <Col>
                                                ...
                                                <p className="normal">Mr Damas Muhammad</p>
                                            </Col>
                                            <Col>
                                                <h3 className="is-grey">Email</h3>
                                                <p className="normal">muhammaddamas81@gmail.com</p>
                                            </Col>
                                            <Col>
                                                <h3 className="is-grey">Nomor Handphone</h3>
                                                <p className="normal">+62 812 3456 782</p>
                                            </Col>
                                        </Row>
                                    </Card>
                                        ...
                                        <Accordion.Item eventKey="0">
                                            ...
                                            <Accordion.Header>
                                                <div className="detail-header-second">
                                                    <p className="normal">Mr. Damas Muhammad <span className="is-grey">| Dewasa</span></p>
                                                </div>
                                            </Accordion.Header>
                                            <Accordion.Body>
                                                <Row className="passenger-detail mt-4">
                                                    <Col>
                                                        <h3 className="is-grey">Tanggal Lahir</h3>
                                                        <p className="normal">1997-12-26</p>
                                                    </Col>
                                                    <Col>
                                                        <h3 className="is-grey">Kewarganegaraan</h3>
                                                        <p className="normal">Indonesia</p>
                                                    </Col>
                                                    <Col>
                                                        <h3 className="is-grey">Nomor KTP</h3>
                                                        <p className="normal">1234567890123456</p>
                                                    </Col>
                                                </Row>
                                                <div className="passenger-baggage-section">
                                                    <h3 className="is-grey">Bagasi</h3>
                                                    <div className="passenger-baggage d-flex normal">
                                                        <p className="mb-0">CGK - DPS</p>
                                                        <img src={Baggage} className="ms-2" alt="" />
                                                        <p className="mb-0 ms-2">20kg</p> 
                                                    </div>
                                                </div>
                                            </Accordion.Body>
                                        </Accordion.Item>
                                    ...
                                    <Card className="fourth-detail mt-4 p-4">
                                        <div className="fourth-detai-header d-flex justify-content-between">
                                            ...
                                            <Button variant="outline-info" onClick={() => setModalShowDetail(true)}>Tampilkan Detail</Button>
                                            <TampilkanDetail
                                                    ...
                                                    <Container className="flight-timeline p-4 ms-0">
                                                        <div className="flight-timeline-horizontal d-flex">
                                                            <div className="timeline-departure">
                                                                <p className="normal mb-0">12:00 <span className="is-grey">| Sen, 02 Jan 2023</span></p>
                                                                <p className="is-grey mb-0">Jakarta (CGK)</p>
                                                                <p className="is-grey">Terminal 2E</p>
                                                            </div>
                                                            ...
                                                            <div className="timeline-arrival has-text-right">
                                                                <p className="normal mb-0">14:50 <span className="is-grey">| Sen, 02 Jan 2023</span></p>
                                                                <p className="is-grey mb-0">Bali Denpasar (DPS)</p>
                                                                <p className="is-grey">Terminal Domestic</p>
                                                            </div>
                                                        </div>
                                                    </Container>
                                                </div>
                                                ...
                                                <Card className="summary">
                                                    <Card.Header className="price-summary-header d-flex justify-content-between ps-2 pb-0">
                                                        <CustomToggle eventKey="0">                                                    
                                                            <h4 className="">
                                                                Berangkat (CGK <i class="remix-icon ri-arrow-right-line is-grey ms-2"></i> DPS)
                                                            </h4>
                                                        </CustomToggle>
                                                    <h4 className="d-inline-flex normal">Rp 780.280</h4>
                                                    </Card.Header>
                                                    <Accordion.Collapse eventKey="0">
                                                    <Card.Body className="price-summary-body pt-0">
                                                        <div className="d-flex justify-content-between">
                                                            <p className="is-grey mb-0">Dewasa x 1</p>
                                                            <p className="is-grey mb-0">Rp 800.280</p>
                                                        </div>
                                                        <div className="d-flex justify-content-between">
                                                            <p className="is-grey">Diskon</p>
                                                            <p className="is-green">- Rp 20.080</p>
                                                        </div>
                                                    </Card.Body>
                                                    </Accordion.Collapse>
                                                </Card>
                                    ...
                                    <Container className="sixth-detail mt-3 p-3">
                                        <div className="order-payment d-flex justify-content-between p-2">
                                            ...
                                            <Button variant="outline-info" onClick={() => setModalShowHistori(true)}>Histori</Button>
                                            <Histori
                                                show={modalShowHistori}
                                                onHide={() => setModalShowHistori(false)}
                                                animation={false}
                                            />
                                        </div>
