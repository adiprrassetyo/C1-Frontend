                      ...
                      onClick={() => {
                        ...
                        dispatch(
                          retriveTickets({
                            params: {
                              from: {
                                city: wish.search.from.city,
                                airport: wish.search.from.airport,
                                code: wish.search.from.code,
                              },
                              to: {
                                city: wish.search.to.city,
                                airport: wish.search.to.airport,
                                code: wish.search.to.code,
                              },
                              type: wish.search.type,
                              date: wish.search.startDate,
                              endDate: wish.search.endDate,
                              willFly: true,
                            },
                            redirect,
                          })
                          ...
                          <div className="summary-info d-flex justify-content-center mt-4 pb-5">
                            <div className="flight-info d-flex">
                              <div className="flight-info-start text-center">
                                <h2>
                                  <strong>{wish.from}</strong>
                                </h2>
                                <h6 className="is-grey">{wish.airport_from}</h6>
                              </div>
                          ...
                          <div className="order-status-container d-flex flex-column align-items-center">
                            <div className="order-code">
                              ...
                              <p className="header-text">
                                <strong>
                                  {wish.id.split("-")[0].toUpperCase() +
                                    wish.id.split("-")[1].toUpperCase()}
                                </strong>
                              </p>
                            </div>
                            <span
                            ...
                            <p className="is-grey mt-3 text-center">
                              ...
                              {moment(wish.date_start).format("DD MMMM YYYY")}
                            </p>
                          </div>
                        </Col>
                      </Row>
